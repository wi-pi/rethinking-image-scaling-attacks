...
from scaleadv.attacks.shadow import CustomShadowAttack
...
if __name__ == '__main__':
    ...
    attacker = CustomShadowAttack(classifier, sigma=0.8, batch_size=400, lambda_s=1.0, lambda_tv=0.1)
    ...
    # attack 1: adv on src
    SAA.save = p1
    stats, x_src_def = SAA.generate_one(dataset, ID, large_inp=None, defense_type=defense, get_defense=400)
    show_table(stats)
